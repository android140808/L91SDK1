 ...
 * Time: 16:46
 */
public class GenderPop extends PopupWindow {
...
//	private Button btn_take_photo, btn_pick_photo, btn_cancel;
	...
	public GenderPop(Activity context, String[] arr,int visibleItems, int currentItem, OnWheelScrollListener wheelScrollListener) {
		super(context);
